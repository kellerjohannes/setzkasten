...
(defparameter *mission2*
  `(
    ...
    ;; ("b1-c28-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c28-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c28-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c29-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c29-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c29-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c29-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c29-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c30-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c30-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c30-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c30-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c30-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c31-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c31-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c31-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c31-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c31-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c32-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c32-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c32-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c32-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c32-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c33-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c33-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c33-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c33-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c33-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c34-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c34-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c34-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c34-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c34-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c35-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c35-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c35-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c35-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c35-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c36-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c36-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c36-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c36-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c36-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c37-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c37-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c37-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c37-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c37-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c37-m2" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c37-m2" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c37-m2" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c37-m2" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c37-m2" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c38-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c38-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c38-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c38-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c38-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ;; ("b1-c39-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ;; ("b1-c39-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ;; ("b1-c39-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ;; ("b1-c39-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ;; ("b1-c39-m1" "e" (:idealised :en) ,*lilypond-backend*)
    ("b1-c39-m2" "a" (:diplomatic) ,*vicentino-types-backend*)
    ("b1-c39-m2" "b" (:idealised) ,*vicentino-types-backend*)
    ("b1-c39-m2" "c" (:idealised :it) ,*lilypond-backend*)
    ("b1-c39-m2" "d" (:idealised :de) ,*lilypond-backend*)
    ("b1-c39-m2" "e" (:idealised :en) ,*lilypond-backend*)
    ("b1-c40-m1" "a" (:diplomatic) ,*vicentino-types-backend*)
    ("b1-c40-m1" "b" (:idealised) ,*vicentino-types-backend*)
    ("b1-c40-m1" "c" (:idealised :it) ,*lilypond-backend*)
    ("b1-c40-m1" "d" (:idealised :de) ,*lilypond-backend*)
    ("b1-c40-m1" "e" (:idealised :en) ,*lilypond-backend*)
