`((:header
   ...
   (:title (:alt (:it "Queste sono tutte le consonanze, con le sue propinque\\e con le propinquissime di Dsolre acuto quarto discendente,\\e quelle di Dsolre quarto ascendenti")
                 (:de "Dies sind alle die Konsonanzen mit ihren ihren propinque\\und den propinquissime von Dsolre acuto quarto absteigend\\und diejenigen von Dsolre quarto aufsteigend.")
