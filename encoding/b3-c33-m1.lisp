`((:header
   ...
   (:voice-labels
    ...
    (s1 v3 (:alt (:it "Cadentia del Tenore")
                 (:de "Kadenz des Tenore")
                 (:en "Cadence of the tenor")))
    ...
    (s1 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s2 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s3 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s4 v4 (:alt (:it "Cadentia del Soprano")
                 (:de "Kadenz des Soprano")
                 (:en "Cadence of the soprano")))
    (s5 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s6 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s7 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s8 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))
    (s9 v4 (:alt (:it "[Cadentia del Basso]")
                 (:de "[Kadenz des Basso]")
                 (:en "[Cadence of the bass]")))))
