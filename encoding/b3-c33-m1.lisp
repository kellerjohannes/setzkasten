`((:header
   ...
   (:voice-labels
    ...
    (s3 v1 "Cadentia dell'alto")
    (s4 v1 "Cadentia del tenore")
    (s5 v1 "Cadentia del soprano")
    (s6 v1 "Cadentia del soprano")
    (s7 v1 "Cadentia del soprano")
    (s8 v1 "Cadentia del soprano")
    (s9 v1 "Cadentia del soprano")

    (s1 v2 "Cadentia dell'alto")
    (s2 v2 "Cadentia del soprano")
    (s3 v2 "Cadentia del tenore")
    (s4 v2 "Cadentia dell'alto")
    (s5 v2 "Cadentia dell'alto")
    (s6 v2 "Cadentia dell'alto")
    (s7 v2 "Cadentia dell'alto")
    (s8 v2 "Cadentia dell'alto")
    (s9 v2 "Cadentia dell'alto")

    (s1 v3 "Cadentia dell tenore")
    (s2 v3 "Cadentia del tenore")
    (s3 v3 "Cadentia del soprano")
    (s4 v3 "Cadentia del basso")
    (s5 v3 "Cadentia del tenore")
    (s6 v3 "Cadentia del tenore")
    (s7 v3 "Cadentia del tenore")
