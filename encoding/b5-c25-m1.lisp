`((:header
   ...
   (:title (:alt (:it "[Consonanze di Elami quinto]")
                 (:de "Konsonanzen von Elami quinto.")
                 (:en "Consonances of Elami quinto")))
   (:section-headings
   ...
   (:section-captions
    ...
    (s7 (:alt (:it "Seste minori / seste maggiori")
              ...
              (:en "Seste minori / seste maggiori"))))
   (:line-headings
    (:alt (:it "Tutte le consonanze di Elami acuto quinto discendenti")
          (:de "Alle absteigenden Konsonanzen von Elami acuto quinto.")
          (:en "All descending consonances of Elami acuto quinto"))
    (:alt (:it "Tutte le consonanze di Elami grave quinto ascendenti")
          (:de "Alle aufsteigenden Konsonanzen von Elami grave quinto.")
          (:en "All ascending consonances of Elami grave quinto"))))
  (:preamble-lilypond
   (:clef-overrides
    (s1 v1 "treble_8")
    (s2 v1 "treble_8")
  ...
  (:data
   (:text 70 58
     (149 1936
          (:alt (:diplomatic "Queste ſono tutte le conſonanze di Elami acuto diſcendente con le ſue propinque,")
                (:critical "Queste ſono tutte le conſonanze di Elami acuto diſcendenti con le ſue propinque,")
                (:coord-barre "TZ1")
                (:coord-norm "T")
                (:comment "In allen Exemplaren: »diſcendente«. Dieser Satz wird in der normalisierten Fassung in die erste Überschrift gesetzt.")
                (:flag :draft) (:id 0))))
   (:text 70 58
     (620 939
        (:alt (:diplomatic "& anchora di Elami graue aſcendente.")
                (:critical "& anchora di Elami graue aſcendenti.")
                (:coord-barre "TZ2")
                (:coord-norm "T")
                (:comment "In allen Exemplaren: »aſcendente«. Dieser Satz wird in der normalisierten Fassung in die zweite Überschrift gesetzt.")
                (:flag :draft) (:id 0))
          ))
   (:text 90 58
