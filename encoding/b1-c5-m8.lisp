`((:header
   ...
   (:section-headings
    ...
    (s6 "da B a A"))
   (:section-captions
    (s1 "per natura: la-sol-fa-la-sol\\mi e re per ascendere")
    (s2 "per natura: fa-mi-la\\fa-mi-mi")
    (s3 "per ♮: la-sol-fa-mi-re\\la-sol-fa-la-sol\\mi per ascendere")
    (s4 "per ♭: la-sol-fa-la-sol\\per ♮: sol-fa-la-sol-fa\\re per ascendere")
  ...
  (:data
   ...
   (:music 2188
           ...
           (:section s2) sb7 b22 sbd6 b22 sb6 bl
           (:section s3) sb6 fl6 sbd6 sh5 sb5 b22 sbd5 b22 sb5 bl
           (:section s4) (:newline) sb5 fl5 sbd5 sh4 sb4 b22 sbd4 b22 sb4 bl
           (:section s5) sb4 b22 sbd3 b22 sb3 bl
           (:section s6) fl3 sb3 b22 sbd2 b22 sb2 b22 bl)
   (:text 70 58
