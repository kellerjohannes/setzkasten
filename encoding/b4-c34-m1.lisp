`((:header
   ...
   (:voice-order
    ...
    (s8 v1 v2))
   (:section-captions
    (s2 (:alt (:it "Il medesimo procedere, & i gradi medesimi.")
              (:de "das gleiche Vorgehen und die gleichen Tonschritte")
              (:en "The same way of proceeding, and the same steps")))
    (s6 (:alt (:it "Il Tenore et il Soprano\\paiono due ottaue et non sono.")
