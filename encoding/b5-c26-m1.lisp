`((:header
   ...
   (:title (:alt (:it "Queste sono tutte le consonanze, e le propinque e propinquissime\\di Dlasolre primo acuto, e discendente,\\e di Dsolre primo medesimamente ascendenti")
                 (:de "Dies sind alle Konsonanzen und die propinque und propinquissime\\von Dlasolre acuto primo, und absteigend,\\und von Dlasolre primo gleichermassen aufsteigend.")
                 (:en "These are all the consonances, and the propinque and propinquissime\\of Dlasolre primo acuto descending,\\and likewise of Dsolre primo ascending")))
   (:section-headings
   ...
   (:section-captions
    ...
    (s7 (:alt (:it "Sesta minore / sesta maggiore")
              ...
              (:en "Sesta minore / sesta maggiore"))))
   (:line-headings
    (:alt (:it "Tutte le consonanze di Dlasolre primo discendenti")
          (:de "Alle absteigenden Konsonanzen von Dlasolre primo.")
          (:en "All descending consonances of Dlasolre primo"))
    (:alt (:it "Tutte le consonanze di Dlasolre primo ascendenti")
          (:de "Alle aufsteigenden Konsonanzen von Dlasolre primo.")
          (:en "All ascending consonances of Dlasolre primo")))
   )
  (:preamble-lilypond
   (:clef-overrides
    (s5 v1 "treble_8")
