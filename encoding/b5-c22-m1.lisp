`((:header
   ...
   (:title (:alt (:it "Queste sono tutte le consonanze di Elami secondo,\\discendenti et ascendenti")
                 (:de "Dies sind alle Konsonanzen von Elami secondo,\\absteigende und aufsteigende")
                 (:en "These are all the consonances of Elami secondo,\\descending and ascending")))
   (:section-headings
    (s1 (:alt (:it "Le sei terze\\[discendenti]")
              (:de "die sechs [absteigenden]\\terze")
              (:en "The six [descending]\\terze")))
    (s2 (:alt (:it " \\Quinta")
              (:de " \\quinta")
              (:en " \\Quinta")))
