`((:header
   ...
   (:title (:alt (:it "Mano enarmonica ascendente, con i semitoni maggiori, e con il tono diviso in\\quattro parti, e delle sette lettere della mano, come si hanno da leggere")
                 (:de "")
                 (:en "Ascending enharmonic hand with _semitoni maggiori_ and with the tono divided into\\four parts, and the seven letters of the hand, as they are to be read")))
   (:section-headings
    (s1 (:alt (:it "da A a B")
              (:de "")
              (:en "from A to B")))
