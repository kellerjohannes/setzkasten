`((:header
   ...
   (:section-captions
    (s1  (:alt (:it "Semitono\\accidentale\\maggiore")
               (:de "")
               (:en "")))
    (s2  (:alt (:it "Semitono\\accidentale\\maggiore")
               (:de "")
               (:en "")))
    (s3  (:alt (:it "Semitono\\naturale\\maggiore")
               (:de "")
               (:en "")))
    (s4  (:alt (:it "Semitono\\accidentale\\maggiore")
               (:de "")
               (:en "")))
    (s5  (:alt (:it "Semitono\\naturale\\maggiore")
               (:de "")
               (:en "")))
    (s6  (:alt (:it "Semitono\\accidentale\\maggiore")
               (:de "")
               (:en "")))
    (s7  (:alt (:it "Semitono\\accidentale\\maggiore")
               (:de "")
               (:en "")))
    (s8  (:alt (:it "Semitono\\accidentale\\minore")
               (:de "")
               (:en "")))
    (s9  (:alt (:it "Semitono\\naturale\\minore")
               (:de "")
               (:en "")))
    (s10 (:alt (:it "Semitono\\accidentale\\minore")
               (:de "")
               (:en "")))))
  (:data
   (:text 90 58
   ...
   (:text 120 58
     (595 975 "semitoni aſcendenti minori & maggiori,"))
   (:text 100 58
     (88 nil "sem.acc.")
     (341 nil "se.acc.")
     (556 nil "se.nat.")
