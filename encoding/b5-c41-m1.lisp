`((:header
   ...
   (:section-captions
    (s1  "Semitono\\accidentale\\maggiore")
    (s2  "Semitono\\accidentale\\maggiore")
    (s3  "Semitono\\naturale\\maggiore")
    (s4  "Semitono\\accidentale\\maggiore")
    (s5  "Semitono\\naturale\\maggiore")
    (s6  "Semitono\\accidentale\\maggiore")
    (s7  "Semitono\\accidentale\\maggiore")
    (s8  "Semitono\\accidentale\\minore")
    (s9  "Semitono\\naturale\\minore")
