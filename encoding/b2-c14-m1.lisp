`((:header
   ...
   (:title "Esempio dei molti modi, che si può accompagnare la terza minore")
   (:section-headings
    (s1 "Grado molle\\e consonante")
    (s2 "Grado incitato\\e molle")
    (s3 "[Grado] incitato\\e molle")
    (s4 "[Gradi] incitati\\ ")
    (s5 "[Grado] incitato\\e molle")
