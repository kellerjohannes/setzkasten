  ...
  (:preamble-lilypond
   (:lyrics
    ...
    (s3 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♭:\" } sol")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ♭:\" } sol")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ♭:\" } sol")))
    (s3 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per n:\" } \\skip 1 fa")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per n:\" } \\skip 1 fa")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in n:\" } \\skip 1 fa")))
    ...
    (s4 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per n:\" } \\skip 1 \\skip 1 re")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per n:\" } \\skip 1 \\skip 1 re")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in n:\" } \\skip 1 \\skip 1 re")))

    (s5 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } la")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } la")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ♮:\" } la")))
    (s5 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per n:\" } \\skip 1 mi")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per n:\" } \\skip 1 mi")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in n:\" } \\skip 1 mi")))
