`((:header
  ...
  (:preamble-lilypond
   (:lyrics
    ...
    (s2 v1 (:alt (:it "\\set stanza = \\markup{ \\column { \\vspace #1.83 \\line { \\normal-text \"per ♭,\" } \\line { \\normal-text \"per n:\" } } \\lower #6.2 \\override #'(font-encoding . fetaBraces) \\lookup \"brace210\" } fa")
                 (:de "\\set stanza = \\markup{ \\column { \\vspace #1.83 \\line { \\normal-text \"per ♭,\" } \\line { \\normal-text \"per n:\" } } \\lower #6.2 \\override #'(font-encoding . fetaBraces) \\lookup \"brace210\" } fa")
                 (:en "\\set stanza = \\markup{ \\column { \\vspace #1.83 \\line { \\normal-text \"in ♭,\" } \\line { \\normal-text \"in n:\" } } \\lower #6.2 \\override #'(font-encoding . fetaBraces) \\lookup \"brace210\" } fa")))
    (s2 v1 "mi")
    (s2 v1 "la")
    (s2 v1 "sol")
    (s2 v1 "re")
    ...
    (s3 v1 (:alt (:it "\\set stanza = \\markup{ \\column { \\vspace #1.83 \\line { \\normal-text \"per ♮,\" } \\line { \\normal-text \"per n:\" } } \\lower #6.2 \\override #'(font-encoding . fetaBraces) \\lookup \"brace210\" } mi")
                 (:de "\\set stanza = \\markup{ \\column { \\vspace #1.83 \\line { \\normal-text \"per ♮,\" } \\line { \\normal-text \"per n:\" } } \\lower #6.2 \\override #'(font-encoding . fetaBraces) \\lookup \"brace210\" } mi")
                 (:en "\\set stanza = \\markup{ \\column { \\vspace #1.83 \\line { \\normal-text \"in ♮,\" } \\line { \\normal-text \"in n:\" } } \\lower #6.2 \\override #'(font-encoding . fetaBraces) \\lookup \"brace210\" } mi")))
    (s3 v1 "fa")
    (s3 v1 "sol")
    (s3 v1 "la")
    (s3 v1 "re")
