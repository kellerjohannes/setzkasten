`((:header
   ...
   (:title (:alt (:it "[Del Gsolreut quinto]")
                 (:de "[Von Gsolreut quinto]")
                 (:en "[Of Gsolreut quinto]")))
   (:section-headings
  ...
  (:data
   ...
   (:text 70 58
          (0 1934 "Queſte ſono tutte le conſonanze di G ſol re ut quinto diſcentendi & aſcendenti."))))
