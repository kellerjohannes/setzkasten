   ...
   (:text 60 58
     ...
     (653 nil
          (:alt (:diplomatic "ſol")
                ...
                (:coord-barre "TZ3 TE3")
                (:coord-norm "G3 US")
                (:comment "In allen Exemplaren lautet die erste Silbe »ſol [fa ut]«.")
                (:flag :ready) (:id 1)))
     (740 nil
          (:alt (:diplomatic "fa")
                (:critical "sol")
                (:coord-barre "TZ3 TE3")
                (:coord-norm "G3 US")
                (:comment "In allen Exemplaren lautet die zweite Silbe »[ſol] fa [ut]«.")
                (:flag :ready) (:id 2)))
     (835 nil
          (:alt (:diplomatic "ut")
                (:critical "fa")
                (:coord-barre "TZ3 TE3")
                (:coord-norm "G3 US")
                (:comment "In allen Exemplaren lautet die dritte Silbe »[ſol fa] ut«.")
                (:flag :ready) (:id 3)))
