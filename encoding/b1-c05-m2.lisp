`((:header
  ...
  (:preamble-lilypond
   (:lyrics
    ...
    (s3 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } ut [ut]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } ut [ut]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ɴ:\" } ut [ut]")))
    ...
    (s4 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } sol [sol]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } sol [sol]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ♮:\" } sol [sol]")))
    (s4 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } re [re]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } re [re]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ɴ:\" } re [re]")))

    (s5 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } la [la]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } la [la]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ♮:\" } la [la]")))
    (s5 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } mi [mi]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } mi [mi]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ɴ:\" } mi [mi]")))

    (s6 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } fa [fa]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } fa [fa]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ɴ:\" } fa [fa]")))
    (s6 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♭:\" } ut [ut]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ♭:\" } ut [ut]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ♭:\" } ut [ut]")))

    (s7 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } sol [sol]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ɴ:\" } sol [sol]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ɴ:\" } sol [sol]")))
    (s7 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♭:\" } re [re]")
                 (:de "\\set stanza = \\markup{ \\normal-text \"per ♭:\" } re [re]")
                 (:en "\\set stanza = \\markup{ \\normal-text \"in ♭:\" } re [re]")))
    (s7 v1 (:alt (:it "\\set stanza = \\markup{ \\normal-text \"per ♮:\" } ut [ut]")
