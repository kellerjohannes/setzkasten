`((:header
   ...
   (:title (:alt (:it "Essempio delle quattro Quinte Diatoniche semplici, scritte con quattro ♭ molli.")
                 (:de "Beispiel der vier einfachen diatonischen quinte, mit vier ♭ molli geschrieben")
