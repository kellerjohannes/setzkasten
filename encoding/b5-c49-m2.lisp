`((:header
   ...
   (:title (:alt (:it "Dimostratione delli diesis enarmonici, incominciando dalla\\divisione delli semitoni minore, nelli toni cromatici\\segnati con li diesis cromatici")
                 (:de "")
                 (:en "")))
   (:section-headings
