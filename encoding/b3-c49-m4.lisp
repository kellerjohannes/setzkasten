`((:header
  ...
  (:data
   ...
   (:music 2241
           ...
           (:alt (:diplomatic fl5 b22 sb5)
                 (:critical fl6 b22 sb6)
                 (:coord-barre "N22")
                 (:coord-norm "N22")
                 (:comment "In allen Exemplaren: D♭. Alternativ könnte diese Note auch in Ė♭ korrigiert werden.")
                 (:flag :ready) (:id 2))
           b22 sb6 b22 br3 bl)))
