`((:header
   ...
   (:title (:alt (:it "Esempio della quarta sincopata a due voci,\\et non sincopata a tre voci, et con il punto:\\come s'ha da comporre a molte voci, et con la sincopa tutta cattiva")
                 (:de "Beispiel der synkopierten quarta mit zwei Stimmen,\\ und nicht synkopiert mit drei Stimmen, und mit der Punktierung;\\und wie sie mit vielen Stimmen setzt und mit der schlechten Synkope.")
