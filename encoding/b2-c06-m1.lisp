`((:header
   ...
   (:title (:alt (:it "Esempio della Quarta sincopata à due uoci,\\et non sincopata à tre uoci, et con il punto:\\come s'hà da comporre à molte uoci, & con la sincopa tutta cattiua.")
