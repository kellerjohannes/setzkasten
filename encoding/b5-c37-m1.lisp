`((:header
   ...
   (:title (:alt (:it "[Queste sono tutte le consonanze di Bfabmi acuto quarto\\con le sue propinque discendenti,\\et il simile di Bmi quarto ascendente]")
                 (:de "Dies sind alle die Konsonanzen von Bfabmi acuto quarto\\mit seinen propinque absteigend\\und dasselbe von Bmi quarto aufsteigend.")
                 (:en "These are all consonances of Bfabmi acuto quarto descending\\with their propinque,\\and the same of Bmi quarto ascending")))
   (:section-headings
