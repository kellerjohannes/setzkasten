`((:header
   ...
   (:section-captions
    ...
    (s8 (:alt (:it "Semitono maggiore:\\diesis maggiore – diesis minore\\Semitono minore:\\diesis minore – diesis minore")
              (:de "")
              (:en "")))
    (s9 (:alt (:it "Semitono maggiore:\\diesis maggiore – diesis minore\\Semitono minore:\\diesis minore – diesis maggiore")
              (:de "")
              (:en "")))
    ...
    (s13 (:alt (:it "Semitono minore /\\semitono maggiore:\\diesis minore – diesis minore – diesis minore")
               (:de "")
               (:en "")))
    (s14 (:alt (:it "Semitono minore:\\diesis minore – diesis maggiore\\Semitono maggiore:\\diesis minore – diesis minore")
               (:de "")
               (:en "")))))
  (:data
   (:text 90 58
