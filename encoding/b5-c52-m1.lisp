`((:header
   ...
   (:section-captions
    ...
    (s9 (:alt (:it "Semitono maggiore:\\diesis maggiore – diesis minore\\Semitono minore:\\diesis minore – diesis minore")
              (:de "")
              (:en "")
              (:comment "Original: Die letzte _diesis_ wird als »diesis maggiore« bezeichnet.")
              (:flag :draft) (:id 1)))
    ...
    (s11 (:alt (:it "Semitono minore:\\diesis maggiore – diesis minore\\Semitono maggiore:\\diesis minore – diesis minore")
               (:de "")
               (:en "")
               (:comment "Original: Die Bezeichnungen »semitono minore« und »semitono maggiore« sind vertauscht.")
               (:flag :draft) (:id 2)))
  ...
  (:data
   ...
   (:text 100 58
     ...
     (:alt (:diplomatic (770 nil "d.ma.d.mi.d.mi.d. mi.d.ma."))
           (:idealised (770 nil "d.ma.d.mi.d.mi.d. mi.d.mi."))
   ...
   (:text 100 58
     ...
     (:alt (:diplomatic (606 nil "mi."))
           (:idealised (606 nil "ma."))
           (:comment "Original: »se.mi.«")
           (:flag :draft) (:id 5))
     (729 nil "se.")

     (:alt (:diplomatic (838 nil "mag."))
           (:idealised (838 nil "min."))
           (:comment "Original: »se.mag.«")
           (:flag :draft) (:id 6))
     (1119 nil "se.")
     (1233 nil "mi. & ma.")
     (1638 nil "se.")
     (:alt (:diplomatic (1753 nil "mi."))
           (:idealised (1753 nil "ma."))
           (:comment "Original: »se.mi.«") (:flag :draft) (:id 7))
     (1878 nil "se.")

     (:alt (:diplomatic (1994 nil "ma."))
           (:idealised (1994 nil "mi."))
           (:comment "Original: »se.ma.«")
           (:flag :draft) (:id 8)))
   (:music 2215
   ...
   (:text 90 58
     ...
     (:alt (:diplomatic (1145 nil "d.ma.d.mi.d.mi.d.mi."))
           (:idealised (1145 nil "d.mi.d.mi.d.mi."))
