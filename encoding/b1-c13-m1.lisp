`((:header
   ...
   (:section-captions
    ...
    (s10 (:alt (:it "la prima metà\\enarmonico e la\\seconda cromatico")
               (:de "")
               (:en "the first half\\is enharmonic\\and the\\ second chromatic")))
    (s11 (:alt (:it "la prima metà\\enarmonico e la\\metà seconda è\\cromatico e\\enarmonico")
               (:de "")
               (:en "the first half\\is enharmonic\\and the second\\is chromatic\\and enharmonic")))
