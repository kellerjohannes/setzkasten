`((:header
   ...
   (:section-captions
    ...
    (s7 (:alt (:it "Seste minori / seste maggiori")
              ...
              (:en "Seste minori / seste maggiori"))))
   (:line-headings
    (:alt (:it "Tutte le consonanze di Elami acuto quarto discendenti")
          (:de "Alle absteigenden Konsonanzen von Elami acuto quarto.")
          (:en "All descending consonances of Elami acuto quarto"))
    (:alt (:it "Tutte le consonanze di Elami grave quarto ascendenti")
          (:de "Alle aufsteigenden Konsonanzen von Elami grave quarto.")
          (:en "All ascending consonances of Elami grave quarto")))
   )
  (:preamble-lilypond
   (:clef-overrides
    (s1 v1 "treble_8")
  ...
  (:data
   (:text 110 58
     (18 2209
         (:alt (:diplomatic "Queſte ſono tutte le conſonanze di Elami acuto diſcendente,& di Elami graue aſcendente.")
               (:critical "Queſte ſono tutte le conſonanze di Elami acuto quarto diſcendenti,& di Elami graue quarto aſcendenti.")
               (:coord-barre "TZ1")
               (:coord-norm "T")
               (:comment "In allen Exemplaren: »Elami acuto« (»quarto« fehlt), »diſcendente« und »aſcendente«. Dieser Satz wird in der normalisierten Fassung auf die beiden Überschriften verteilt.")
               (:flag :ready) (:id 5))
         ))
   (:text 110 58
     (57 nil "le cinque 3.")
