`((:header
   ...
   (:title (:alt (:it "Mano della divisione del tono in quattro diesis enarmonici ascendenti\\con lo semitono minore")
                 (:de "")
                 (:en "Hand of the division of the _tono_ into four ascending _diesis enarmonici_\\with the _semitono minore_")))
   (:section-headings
   ...
   (:section-captions
    ...
    (s6 (:alt (:it "per nat.: mi-mi-fa\\la discende")
              (:de "")
              (:en "")))
    (s7 (:alt (:it "per nat.: fa-re-mi-fa-sol\\per ♭: ut-re-mi-fa-re")
              (:de "")
              (:en "")
