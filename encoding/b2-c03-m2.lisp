`((:header
   ...
   (:title (:alt (:it "Essempio d'andare all'Vnisono con uarij salti, naturali et accidentali")
   ...
   (:section-captions
    ...
    (s6 (:alt (:it "à cinque [voci]")
              ...
              (:de "mit fünf [Stimmen]")
              (:en "in five voci")))
    (s7 (:alt (:it "salto dubioso")
              (:de "zweifelhafter Sprung")
              (:en "dubious leap")))
    (s8 (:alt (:it "[salto] dubioso")
              (:de "zweifelhafter Sprung")
              (:en "dubious leap")))
    ;; LC: 'Salto' in den Übersetzungen ergänzen
    ;;
    ;; JK: habe ich ergänzt.
    ;;
    ;; DONE
    (s9 (:alt (:it "à due chori")
              (:de "für zwei Chöre")
              ;; LUIGI: 'Für zwei Chöre'?
              ;;
              ;; JK: habe ich angepasst.
              ;;
              ;; DONE
              (:en "for two choirs")))
    (s10 (:alt (:it "à due chori")
               (:de "mit zwei Chören")
               (:en "for two choirs")))
    (s11 (:alt (:it "à sei [voci]")
               (:de "mit sechs\\[Stimmen]")
               (:en "in six [voci]")))
    (s12 (:alt (:it "à cinque [voci]")
               (:de "mit fünf\\[Stimmen]")
               (:en "in five [voci]")))
    (s13 (:alt (:it "à otto [voci]")
               (:de "mit acht\\[Stimmen]")
               (:en "in eight [voci]")))
    (s14 (:alt (:it "à otto [voci] dubioso")
               (:de "mit acht\\[Stimmen],\\bedenklich")
               (:en "in eight [voci], dubious")))
    (s15 (:alt (:it "à otto [voci]")
               (:de "mit acht\\[Stimmen]")
               (:en "in eight [voci]")))
    (s16 (:alt (:it "à otto [voci]")
               (:de "mit acht\\[Stimmen]")
               (:en "in eight [voci]")))
    (s17 (:alt (:it "à otto [voci]")
               (:de "mit acht\\[Stimmen]")
               (:en "in eight [voci]")))
    (s18 (:alt (:it "à otto [voci]")
               (:de "mit acht\\[Stimmen]")
               (:en "in eight [voci]"))))
   (:voice-order
    (s1 v1 v2)
  ...
  (:data
   ...
   (:music 2220
           ...
           (:section s2) sb6 b38 sb6 bl
           (:section s3) sb7 b38 sb7 bl
   ...
   (:music 2223
           (:voice v2)
           (:section s1) cclef7 b22 mrest5 b22 sb5 m7 bl
           (:section s2) mrest3 b22 sb4 m6 bl
           (:section s3) sb4 b38 sb7 bl
           (:section s4) sb3 b38 sb7 bl
           (:section s5) sb4 b38 sh7 b38 sb7 bl
           (:section s6) sb4 b38 sb8 b22 bl
   ...
   (:music 2221
           (:voice v1)
           (:section s11) cclef7 b38 sb5 b38 sb3 b38 bl
           (:section s12) b38 sb6 b38 sb4 b38 bl
