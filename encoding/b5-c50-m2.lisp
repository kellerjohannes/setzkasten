`((:header
   ...
   (:section-captions
    ...
    (s2 (:alt (:it "Semitono minore /\\semitono maggiore:\\diesis maggiore – diesis minore – diesis minore")
              (:de "semitono minore /\\semitono maggiore:\\diesis maggiore – diesis minore – diesis minore")
              (:en "Semitono minore /\\semitono maggiore:\\diesis maggiore – diesis minore – diesis minore")))
