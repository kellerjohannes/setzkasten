`((:header
   ...
   (:section-headings
    ...
    (s4 "Le quattro terze ascendenti\\con le [sue] propinque")
    (s5 " \\Quinta")
    (s6 "Le quattro seste ascendenti\\con le sue propinque"))
   (:section-captions
    (s1 "Terza minore / terza maggiore")
    (s2 "")
    (s3 "Sesta minore / sesta maggiore")
    (s4 "Terza minore / terza maggiore")
    (s5 "")
    (s6 "Sesta minore / sesta maggiore"))
   (:voice-labels
    (:all v1 "")
    (:all v2 ""))
   (:line-headings
