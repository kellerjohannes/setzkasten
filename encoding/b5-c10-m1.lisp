...
`((:header
   ...
   (:title (:alt (:it "Di Alamire terzo, le consonanze discendenti et ascendenti.")
                 (:de "Von Alamire terzo, die absteigenden und aufsteigenden Konsonanzen.")
                 (:en "Of Alamire terzo, the descending and ascending consonances")))
   (:section-headings
   ...
   (:section-captions
    ...
    (s4 (:alt (:it "Terza minore / terza maggiore")
              (:de "terza minore / terza maggiore")
              (:en "Terza minore / etrza maggiore")))
    (s5 "")
