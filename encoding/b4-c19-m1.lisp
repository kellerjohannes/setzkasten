`((:header
   ...
   (:title (:alt (:it "Esempio a due voci, delle quinte antecedenti,\\et sussequenti, con il buono et megliore procedere\\di ♮ et di ♭ et del diesis cromatico")
                 (:de "Beispiel für zwei Stimmen von quinte voranstehend\\und nachfolgend, mit dem guten und besseren Fortschreiten\\mit ♮ und ♭ und der diesis cromatico")
   ...
   (:section-headings
    ...
    (s2 (:alt (:it "Quinta antecedente\\et sussequente")
              (:de "quinta voranstehend\\und nachfolgend")
