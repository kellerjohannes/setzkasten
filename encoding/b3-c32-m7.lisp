`((:header
   ...
   (:title (:alt (:it "Essempio di molte Cadentie del settimo Modo della musica participata\\& mista per ♮ quadro.")
                 (:de "Beispiel von vielen Kadenzen des siebten Modus der musica participata\\und mista per ♮ quadro")
                 (:en "Example of many cadences of the seventh mode, of musica participata\\and mista in ♮ quadro")))
   (:voice-labels
