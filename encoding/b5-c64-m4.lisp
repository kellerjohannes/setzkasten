`((:header
   ...
   (:title (:alt (:it "Esempio delli salti dell'ottave, ch'occorreno nelle compositioni\\sopra il nostro stromento.")
                 (:de "Beispiel von Sprüngen der ottave, die in Kompositionen\\auf unserem Instrument vorkommen.")
                 (:en "Example of the leaps of the ottave, which occur in compositions\\on our instrument")))
   (:section-captions
    (s1 (:alt (:it "Naturale")
              (:de "naturale")
              (:en "Naturale")))
    ...
    (s3 (:alt (:it "Accidentale")
              (:de "accidentale")
              (:en "Accidentale")))
    (s4 (:alt (:it "Accidentale\\et naturale")
              (:de "accidentale\\und naturale")
              (:en "Accidentale\\and naturale")))
    (s5 (:alt (:it "Accidentale\\et naturale")
              (:de "accidentale\\und naturale")
              (:en "Accidentale\\and naturale")))
