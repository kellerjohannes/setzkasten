`((:header
   ...
   (:section-headings
    ...
    (s54 (:alt (:it "Sesto ordine cromatico enarmonico")
               (:de "sechset Reihe cromatico enarmonico")
               (:en "Sixth ordine cromatico enarmonico")))
