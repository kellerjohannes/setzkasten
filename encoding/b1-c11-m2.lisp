  ...
  (:data
   ...
   (:music 1400
           ...
           (:alt (:diplomatic sbd4)
                 ...
                 (:coord-barre "N3")
                 (:coord-norm "G1 N3")
                 (:comment "Original: Ġ♯. Begründungen: Vicentino würde diese Tonhöhe als A♭ notieren. Die Ganztonteilung mit A♭ wurde bereits im vorhergehenden Beispiel (b1-c11-m1) behandelt, was die originale Gestalt redundant macht.")
                 (:flag :ready) (:id 1))
