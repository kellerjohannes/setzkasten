`((:header
   ...
   (:title (:alt (:it "Essempio dei gradi di terza minore accidentale, composti e incomposti")
                 ...
                 (:en-kursiv "Example of the steps of the _terza minore accidentale_, _composti_ and _incomposti_")))
   (:section-captions
    (s1 (:alt (:it "grado di terza minore\\accidentale incomposto")
              ...
              (:en-kursiv "step of _terza minore_\\_accidentale incomposto_")))
    (s2 (:alt (:it "grado di terza minore\\accidentale composto")
              ...
              (:en-kursiv "step of _terza minore_\\_accidentale composto_")
              ))
