`((:header
   ...
   (:title (:alt (:it "Essempio dei gradi di terza minore accidentale, composti e incomposti")
                 ...
                 (:de-kursiv "Beispiel der Schritte der _terza minore accidentale, composti _ und _incomposti_")
                 (:en "Example of the steps of the terza minore accidentale, composti and incomposti")
                 (:en-kursiv "Example of the steps of the _terza minore accidentale, composti _ and _incomposti_")))
   (:section-captions
    (s1 (:alt (:it "grado di terza minore\\accidentale incomposto")
              ...
              (:de-kursiv "Schritt der_terza minore_\\_accidentale incomposto_")
              (:en "step of terza minore\\accidentale incomposto")
              (:en-kursiv "step of_terza minore_\\_accidentale incomposto_")))
    (s2 (:alt (:it "grado di terza minore\\accidentale composto")
              (:de "Schritt der terza minore\\accidentale composto")
              (:de-kursiv "Schritt der_terza minore_\\_accidentale composto_")
              (:en "step of terza minore\\accidentale composto")
              (:en-kursiv "step of_terza minore_\\_accidentale composto_")
              ))
