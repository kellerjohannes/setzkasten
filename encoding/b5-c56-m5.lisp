`((:header
   ...
   (:title (:alt (:it "[Regola di ritrovare le sette ottave sopra Gsolreut terzo,\\con li sottoscritti esempi]")
                 (:de "Methode, die sieben ottave über Gsolreut terzo zu finden,\\mit den unten geschriebenen Beispielen.")
                 (:en "Rule for finding the seven ottave on Gsolreut terzo,\\with the examples written below")))
   (:section-headings
