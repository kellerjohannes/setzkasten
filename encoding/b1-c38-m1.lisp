`((:header
   ...
   (:section-captions
    ...
    (s4 (:alt (:it "[salto di] più di quinta\\imperfetta accidentale\\composto")
              (:de "[Sprung] composto\\der più di quinta\\imperfetta accidentale")
