`((:header
   ...
   (:section-headings
    (s1 (:alt (:it "Primo ordine naturale diatonico")
              (:de "erste Anordnung naturale diatonico")
              (:en "First ordine naturale diatonico")))
    (s10 (:alt (:it "Secondo ordine naturale diatonico")
              (:de "zweite Anordnung naturale diatonico")
              (:en "Second ordine naturale diatonico")))
    (s19 (:alt (:it "Terzo ordine naturale diatonico")
              (:de "dritte Anordnung naturale diatonico")
              (:en "Third ordine naturale diatonico")))
    (s28 (:alt (:it "Quarto ordine naturale diatonico")
              (:de "vierte Anordnung naturale diatonico")
              (:en "Fourth ordine naturale diatonico")))
    (s37 (:alt (:it "Quinto ordine naturale diatonico")
              (:de "fünfte Anordnung naturale diatonico")
              (:en "Fifth ordine naturale diatonico")))
    (s46 (:alt (:it "Sesto ordine naturale diatonico")
              (:de "sechste Anordnung naturale diatonico")
              (:en "Sixth ordine naturale diatonico")))
    (s55 (:alt (:it "Settimo ordine diatonico naturale")
              (:de "siebte Anordnung naturale diatonico")
              (:en "Seventh ordine naturale diatonico")))

    (s2 (:alt (:it "Primo ordine cromatico enarmonico")
              (:de "erste Anordnung cromatico enarmonico")
              (:en "First ordine cromatico enarmonico")))
    (s11 (:alt (:it "Secondo ordine cromatico enarmonico")
              (:de "zweite Anordnung cromatico enarmonico")
              (:en "Second ordine cromatico enarmonico")))
    (s20 (:alt (:it "Del terzo ordine cromatico enarmonico")
               (:de "von der dritten Anordnung cromatico enarmonico")
               (:en "Of the third ordine cromatico enarmonico")))
    (s29 (:alt (:it "Del quarto ordine cromatico enarmonico")
               (:de "von der vierte Anordnung cromatico enarmonico")
               (:en "Of the fourth ordine cromatico enarmonico")))
    (s38 (:alt (:it "Quinto ordine cromatico enarmonico")
               (:de "fünfte Anordnung cromatico enarmonico")
               (:en "Fifth ordine cromatico enarmonico")))
    ...
    (s30 (:alt (:it "Del quarto ordine cromatico enarmonico")
               (:de "von der vierten Anordnung cromatico enarmonico")
               (:en "Of the fourth ordine cromatico enarmonico")))
    ...
    (s42 (:alt (:it "Quinto ordine cromatico enarmonico")
               (:de "fünften Anordnung cromatico enarmonico")
               (:en "Fifth ordine cromatico enarmonico")))
