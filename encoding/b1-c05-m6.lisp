`((:header
   ...
   (:title "Mano enarmonica discendente con i semitoni minori, nel principio del tono per\\le sette lettere della mano, con il tono diviso in quattro parti: e come si ha da leggere")
   (:section-headings
    (s1 "da A a G")
    (s2 "da G a F")
    (s3 "da F a E")
    ...
    (s7 "da B a A"))
   (:section-captions
    (s1 "per natura: la-sol-fa-la-sol\\mi e re ascendino")
    (s2 "per natura: sol-fa-la-sol-fa\\re e ut ascendeno")
    (s3 "per natura: fa-mi-la per discendere\\fa-mi-mi per ascendere")
    (s4 "per ♮: la-sol-fa-mi-re\\la-sol-fa-la-sol\\mi ascende")
    (s5 "per ♭: la-sol-fa-la-sol\\per ♮: sol-fa-la-sol-fa")
    (s6 "per ♮: fa-mi-mi")
