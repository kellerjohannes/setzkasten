`((:header
   ...
   (:section-headings
    (s1 ""))
   (:section-captions
    (s1 "semitono minore\\composto")
    (s2 "semitono minore\\composto")
    (s3 "semitono minore\\composto")
    (s4 "semitono minore\\incomposto")
    (s5 "semitono minore\\incomposto")
    (s6 "semitono minore\\incomposto")
    (s7 "diesis maggiore\\per semitono minore\\incomposto")
  ...
  (:data
   (:music 2206
           ...
           (:alt (:diplomatic sb9) (:idealised sb8)) b22 fl8 b22 sb8 bl
           (:section s7)
           sb7 b22 sbd6 bl
           (:section s8)
           sb6 fl6 sb6 bl)
