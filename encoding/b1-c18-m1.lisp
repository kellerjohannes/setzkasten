`((:header
   ...
   (:section-captions
    (s1 (:alt (:it "semitono minore\\composto")
              (:de "")
              (:en "_semitono minore_\\_composto_")))
    ...
    (s4 (:alt (:it "semitono minore\\incomposto")
              (:de "")
              (:en "_semitono minore_\\_incomposto_")))
    ...
    (s7 (:alt (:it "diesis maggiore\\per semitono minore\\incomposto")
              (:de "")
              (:en "_diesis maggiore_\\_per semitono minore_\\_incomposto_")))
    (s8 (:alt (:it "semitono minore\\enarmonico incomposto")
              (:de "")
              (:en "_semitono minore_\\_enarmonico incomposto_")))))
  (:data
   (:music 2206
           (:voice v1)
           (:section s1)
