`((:header
   ...
   (:section-captions
    ...
    (s4 (:alt (:it "semitono minore\\incomposto")
              (:de "")
              (:en "_semitono minore\\incomposto_")))
    ...
    (s7 (:alt (:it "diesis maggiore\\per semitono minore\\incomposto")
              (:de "")
              (:en "_diesis maggiore\\per semitono minore\\incomposto_")))
    (s8 (:alt (:it "semitono minore\\enarmonico incomposto")
              (:de "_semitono minore\\enarmonico incomposto_")
              (:en "")))))
  (:data
   (:music 2206
           (:voice v1)
