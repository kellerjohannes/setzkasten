`((:header
   ...
   (:title (:alt (:it "Essempio del tono maggiore, composto e incomposto")
   ...
   (:section-captions
    (s1 (:alt (:it "tono maggiore\\composto")
              (:de "tono maggiore\\composto")
              (:en "tono maggiore\\composto")))
    (s2 (:alt (:it "tono maggiore\\incomposto")
              (:de "tono maggiore\\incomposto")
              (:en "tono maggiore\\incomposto")))
    (s3 (:alt (:it "tono maggiore\\composto")
              (:de "tono maggiore\\composto")
              (:en "tono maggiore\\composto")))
    (s4 (:alt (:it "tono maggiore\\incomposto")
              (:de "tono maggiore\\incomposto")
              (:en "tono maggiore\\incomposto")))
    (s5 (:alt (:it "tono maggiore\\incomposto")
              (:de "tono maggiore\\incomposto")
              (:en "tono maggiore\\incomposto")))
    (s6 (:alt (:it "tono maggiore\\composto")
              (:de "tono maggiore\\composto")
              (:en "tono maggiore\\composto")))
    (s7 (:alt (:it "tono maggiore\\composto")
              (:de "tono maggiore\\composto")
              (:en "tono maggiore\\composto")))
    (s8 (:alt (:it "tono maggiore\\incomposto")
              (:de "tono maggiore\\incomposto")
              (:en "tono maggiore\\incomposto")))
    (s9 (:alt (:it "tono maggiore\\incomposto")
              (:de "tono maggiore\\incomposto")
              (:en "tono maggiore\\incomposto")))))
  (:data
   (:text 100 58
