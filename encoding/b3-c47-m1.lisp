`((:header
   ...
   ;;
   ;; JK: soll so ergänzt werden.
   ;;
   ;; TRANSLATION
   ;;
   ;; OPEN
   (:title (:alt (:it "[Essempio delle sette ottaue enarmoniche.]")
                 (:de)
                 (:en)))
   (:section-captions
    (s1 (:alt (:it "Prima ottaua enarmonica")
              (:de "erste enharmonische ottava")
              (:en "First enharmonic ottava")))
    (s2 (:alt (:it "Seconda ottaua enarmonica")
              (:de "zweite enharmonische ottava")
              (:en "Second enharmonic ottava")))
    (s3 (:alt (:it "Terza ottaua enarmonica")
              (:de "dritte enharmonische ottava")
              (:en "Third enharmonic ottava")))
    (s4 (:alt (:it "Quarta ottaua enarmonica")
              (:de "vierte enharmonische ottava")
              (:en "Fourth enharmonic ottava")))
    (s5 (:alt (:it "Quinta ottaua enarmonica")
              (:de "fünfte enharmonische ottava")
              (:en "Fifth enharmonic ottava")))
    (s6 (:alt (:it "Sesta ottaua enarmonica")
              (:de "sechste enharmonische ottava")
              (:en "Sixth enharmonic ottava")))
    (s7 (:alt (:it "Settima ottaua enarmonica")
              (:de "siebte enharmonische ottava")
  ...
  (:data
   ...
   (:music 2225
           ...
           ;;
           ;; JK: ich finde die Lösung, diesen Sachverhalt im Rahmen des Kapitelkommentars zu
           ;; erläutern, den besten Weg. Das braucht aus meiner Sicht keine Gruppendiskussion.
           ;;
           ;; OPEN
           (:section s6)
           (:alt (:diplomatic)
