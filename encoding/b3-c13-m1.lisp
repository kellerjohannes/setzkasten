`((:header
   ...
   (:title (:alt (:it "Essempio delle tre Quarte Diatoniche per ♭ molle,\\composte & incomposte.")
                 (:de "Beispiel der drei diatonischen quarte per ♭ molle,\\composte und incomposte")
