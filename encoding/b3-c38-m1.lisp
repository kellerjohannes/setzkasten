`((:header
   ...
   (:section-headings
    (s1 (:alt (:it "Prima ottava cromatica")
              (:de "Erste chromatische ottava.")
              (:en "First chromatic ottava")))
    (s2 (:alt (:it "Seconda ottava cromatica")
              (:de "Zweite chromatische ottava.")
              (:en "Second chromatic ottava")))
    (s3 (:alt (:it "Terza ottava cromatica")
              (:de "Dritte chromatische ottava.")
              (:en "Third chromatic ottava")))
    (s4 (:alt (:it "Quarta ottava cromatica")
              (:de "Vierte chromatische ottava.")
              (:en "Fourth chromatic ottava")))
    (s5 (:alt (:it "Quinta ottava cromatica")
              (:de "Fünfte chromatische ottava.")
              (:en "Fifth chromatic ottava")))
    (s6 (:alt (:it "Sesta ottava cromatica")
              (:de "Sechste chromatische ottava.")
              (:en "Sixth chromatic ottava")))
    (s7 (:alt (:it "Settima ottava cromatica")
              (:de "Siebte chromatische ottava.")
              (:en "Seventh chromatic ottava")))))
  (:preamble-lilypond
   (:clef-overrides
    (s6 v1 "treble_8")
    (s7 v1 "treble_8")))
