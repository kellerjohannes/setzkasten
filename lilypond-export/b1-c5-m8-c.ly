...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Mano enarmonica, con semitoni maggiori discendenti nel principio del tono, con il tono, in quattro parti diviso, per le sette lettere della mano."} }
    }
    \line {
      \center-column {
        \null
