...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio d'alcuni toni e semitoni accidentali"} }
    }
    \null
    \line {
      \center-column {
