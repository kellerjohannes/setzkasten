...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio del tono maggiore, composto e incomposto"} }
    }
    \null
    \line {
      \center-column {
