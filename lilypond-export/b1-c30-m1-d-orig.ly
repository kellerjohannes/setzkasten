...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio dei gradi di terza maggiore accidentale, incomposti e composti"} }
    }
    \null
    \line {
      \center-column {
