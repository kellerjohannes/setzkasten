...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio del grado di terza maggiore naturale, incomposto e composto"} }
    }
    \null
    \line {
      \center-column {
      ...
      \center-column {
        ...
        \null
        \line {
          \left-align {  \normal-text "terza maggiore" }
        }
        \line {
          \left-align {  \normal-text "composta naturale" }
        }
