...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio del salto della quarta naturale e de suoi gradi incomposto et composto"} }
    }
    \null
    \line {
      \center-column {
        \line {
          \left-align {  \normal-text "prima quarta" }
        }
