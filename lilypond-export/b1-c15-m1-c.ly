...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio delli gradi, delli diesis minori enarmonici, ascendenti e discendenti"} }
    }
    \null
    \line {
      \center-column {
