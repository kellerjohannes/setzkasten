...
\markup {
  \center-column {
    \line {
      \center-align
      \fontsize#3 { \concat { \normal-text "Essempio dei gradi di terza più di minore composto e incomposto"} }
    }
    \null
    \line {
      \center-column {
